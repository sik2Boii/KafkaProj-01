...
/**
 * FileToDBConsumer는 Kafka에서 메시지를 소비하고,
 * 이를 OrderDTO 객체로 변환하여 데이터베이스에 삽입하는 역할을 하는 클래스입니다.
 *
 * @param <K> 메시지 키의 타입
 * @param <V> 메시지 값의 타입
 */
public class FileToDBConsumer<K extends Serializable, V extends Serializable> {
    ...
    public void initConsumer() {
        ...
        shutdownHookToRuntime(this.kafkaConsumer); // 애플리케이션 종료 시 소비자를 안전하게 종료하기 위한 후크 등록
    }
