...
public class ConsumerPartitionAssignSeek {
    ...
    public static void main(String[] args) {
        ...
        // 특정 파티션의 오프셋을 직접 읽는 경우는 드뭄
        // 유지보수 등의 이유로 이런 작업이 필요하면 기존 그룹과 다른 그룹 ID를 설정하고,
        // 작업 완료 후 해당 그룹을 삭제하여 클러스터 리소스 관리
        ...
        kafkaConsumer.seek(topicPartition, 10L); // 특정 파티션의 오프셋을 10으로 지정, 데이터가 없으면 처음부터 읽음
